...
submission_file = 'submission_19.csv'
...
model_name = "unet_best_fold_revised_sgd_woflip_lh_fixed005_3.model"
...
np.save('preds_valid_rev_sgd_woflip_lh_fixed005_'+str(i)+'.npy', preds_valid)
np.save('y_valid_rev_sgd_lh_woflip_lh_fixed005_'+str(i)+'.npy', y_valid)
np.save('preds_test_rev_sgd_lh_woflip_lh_fixed005_'+str(i)+'.npy', preds_test)
...
preds_test1 = np.load('preds_test_rev_sgd_lh_aug_1.npy')    
preds_test2 = np.load('preds_test_rev_sgd_lh_aug_2.npy')    
