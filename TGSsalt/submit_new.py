...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 22:11:16 2018
...
submission_file = 'submission_17.csv'
...
np.save('preds_valid_unet_resent_model14_new_lh_'+str(i)+'.npy', preds_valid)
np.save('y_valid_unet_resent_model14_new_lh_'+str(i)+'.npy', y_valid)
np.save('preds_test_unet_resent_model14_new_lh_'+str(i)+'.npy', preds_test)

final_prediction = preds_valid
final_truth = y_valid
sumbit_prediction = preds_test
