...
def my_main(batch_size, epochs, start_neurons_arg, dropout_arg, train_mask_threshold, lr_arg):
    ...
    def build_model(input_layer, start_neurons, DropoutRatio = 0.5):
        resnet_base = ResNet34(input_shape=(img_size_target,img_size_target,3), weights='imagenet', classes=1000)
    ...
    fold = 3
    load_model_file = "/home/neha/Desktop/code/ML/Kaggle/TGSsalt/models/resent34_unet_lz_run2_"+str(fold)+".model"
    save_model_file = "/home/neha/Desktop/code/ML/Kaggle/TGSsalt/models/resent34_unet_lz_run_cy_"+str(fold)+".model"
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_my_iou_metric', mode = 'max',factor=0.5, patience=8, min_lr=1e-10, verbose=1)
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_my_iou_metric_2', mode = 'max',factor=0.5, patience=8, min_lr=1e-10, verbose=1)
