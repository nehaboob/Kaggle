...
def my_main(batch_size, epochs, start_neurons_arg, dropout_arg, train_mask_threshold, lr_arg):
    ...
    def build_model(input_layer, start_neurons, DropoutRatio = 0.5):
        ...
        # 7 -> 14
        deconv4 = Conv2D(512, 2, activation = 'relu', padding = 'same')(UpSampling2D()(conv5))
        ...
        # 14 -> 28
        deconv3 = Conv2D(256, 2, activation = 'relu', padding = 'same')(UpSampling2D()(uconv4))
        ...
        # 28 -> 56
        deconv2 = Conv2D(128, 2, activation = 'relu', padding = 'same')(UpSampling2D()(uconv3))
        ...
        # 56 -> 112
        deconv1 = Conv2D(64, 2, activation = 'relu', padding = 'same')(UpSampling2D()(uconv2))
        ...
        """
        image_pool = AveragePooling2D(pool_size=4)(conv5)
        ...
        """                                
        conv_up6 = Conv2D(512, 2, activation = 'relu', padding = 'same')(UpSampling2D()(conv5))
        conv_up6 = concatenate([conv_up6, conv4], axis=-1)
        conv6 = conv_block_simple(conv_up6, 512, "conv6_1")
        conv6 = conv_block_simple(conv6, 512, "conv6_2")
    
        conv_up7 = Conv2D(256, 2, activation = 'relu', padding = 'same')(UpSampling2D()(conv6))
        up7 = concatenate([conv_up7, conv3], axis=-1)
        conv7 = conv_block_simple(up7, 256, "conv7_1")
        conv7 = conv_block_simple(conv7, 256, "conv7_2")
    
        conv_up8 = Conv2D(128, 2, activation = 'relu', padding = 'same')(UpSampling2D()(conv7))
        up8 = concatenate([conv_up8, conv2], axis=-1)
        #up8 = Dropout(DropoutRatio)(up8)
        conv8 = conv_block_simple(up8, 128, "conv8_1")
        conv8 = conv_block_simple(conv8, 128, "conv8_2")
    
        conv_up9 = Conv2D(64, 2, activation = 'relu', padding = 'same')(UpSampling2D()(conv8))
        up9 = concatenate([conv_up9, conv1], axis=-1)
        #up9 = Dropout(DropoutRatio)(up9)
        conv9 = conv_block_simple(up9, 64, "conv9_1")
        conv9 = conv_block_simple(conv9, 64, "conv9_2")
    
        conv_up10 = Conv2D(64, 2, activation = 'relu', padding = 'same')(UpSampling2D()(conv9))
        up10 = concatenate([conv_up10, resnet_base.input], axis=-1)
        ...
        x = Activation('sigmoid')(output_layer)
        model = Model(resnet_base.input, x)
        """
        return model
    ...
    save_model_file = "/home/neha/Desktop/code/ML/Kaggle/TGSsalt/models/resent34_unet_bce_super_"+str(fold)+".model"
