...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  9 12:01:51 2018

@author: neha
Notes: integrating sacred to store experment results

Resent 50 with squeeze and excitation blocks experiments
"""
...
def my_config():
    ...
    lr_arg = 0.001
    exp_notes = "Resnet 50 with unetdecoder with squeeze and excite block. IMG size 128. Weighted bce dice loss."
...
def my_main(batch_size, epochs, start_neurons_arg, dropout_arg, train_mask_threshold, lr_arg):
    ...
    from keras.layers.core import Lambda, SpatialDropout2D, Dense
