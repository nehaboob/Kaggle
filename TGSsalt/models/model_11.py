...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 10 10:25:31 2018
...
def my_main(batch_size, epochs, start_neurons_arg, dropout_arg, train_mask_threshold, lr_arg):
    ...
    model.summary()
    save_model_name = 'unet_resent_11.model' 
    ...
    """
    save_model_name = '/home/neha/Desktop/code/ML/Kaggle/TGSsalt/models/unet_resent_11.model' 
    ...
    model.summary()
    save_model_name = 'unet_resent_11_l.model' 
