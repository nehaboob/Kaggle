...
img_width = 150
img_height = 150
weights_path = 'ex1_model_crop_auto_500ep.h5'
...
class_idx = 2
penultimate_layer_idx = 24

conv_filters('conv2d_1.png', model, 11)
dense_layer('type_2_input.png',model, layer_idx, class_idx)
grad_cam(root_path, 'auto_crop.png', img_width, img_height, model, layer_idx, penultimate_layer_idx)
