...
root_path = "../../cam_samples"
img_width = 300
img_height = 300
weights_path = 'ex1_model_crop_dropout_4_epoch1000.h5'
...
conv_filters('layer2', model, layer_idx)
dense_layer('type_1_input.png',model, layer_idx, class_idx)
grad_cam(root_path, 'type_3_grad_cam_rescale.png', img_width, img_height, model, layer_idx, penultimate_layer_idx)
