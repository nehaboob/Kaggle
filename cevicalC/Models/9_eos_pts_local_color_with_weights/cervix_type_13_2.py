...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 16:47:22 2017
...
train_data_dir = '../../data/train_split_clahe_256px_crop_auto_30_lcolor_13_2'
val_data_dir = '../../data/val_split_clahe_256px_crop_auto_30_lcolor_13_2'
best_model_file = "./ex1_model_clahe_lcolor_30wh_13_2.h5"

Ctypes = ['Type_13', 'Type_2']
...
#x = Flatten()(x)
x = Dropout(0.35)(x)
x = Dense(n_classes, activation='softmax', kernel_regularizer=regularizers.l2(0.06))(x)
...
lrreduce = ReduceLROnPlateau(monitor='val_loss', factor=0.7, patience=50, verbose=1, mode='auto', epsilon=0.0001, cooldown=0, min_lr=0)
