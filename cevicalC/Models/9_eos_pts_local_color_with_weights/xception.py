...
best_model_file = "./ex1_model_clahe_lcolor_30wh_over_weights.h5"
...
x = SeparableConv2D(16, (3, 3), padding='same', use_bias=False, name='block4_sepconv1')(x)
x = BatchNormalization(name='block4_sepconv1_bn')(x)
x = Activation('relu', name='block4_sepconv2_act')(x)
x = SeparableConv2D(16, (3, 3), padding='same', use_bias=False, name='block4_sepconv2')(x)
...
for i in range(8):
    ...
    x = SeparableConv2D(16, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv1')(x)
    x = BatchNormalization(name=prefix + '_sepconv1_bn')(x)
    x = Activation('relu', name=prefix + '_sepconv2_act')(x)
    x = SeparableConv2D(16, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv2')(x)
    x = BatchNormalization(name=prefix + '_sepconv2_bn')(x)
    x = Activation('relu', name=prefix + '_sepconv3_act')(x)
    x = SeparableConv2D(16, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv3')(x)
...
x = SeparableConv2D(32, (3, 3), padding='same', use_bias=False, name='block13_sepconv2')(x)
x = BatchNormalization(name='block13_sepconv2_bn')(x)

x = MaxPooling2D((3, 3), strides=(2, 2), padding='same', name='block13_pool')(x)
x = layers.add([x, residual])

x = SeparableConv2D(32, (3, 3), padding='same', use_bias=False, name='block14_sepconv1')(x)
x = BatchNormalization(name='block14_sepconv1_bn')(x)
x = Activation('relu', name='block14_sepconv1_act')(x)

x = SeparableConv2D(32, (3, 3), padding='same', use_bias=False, name='block14_sepconv2')(x)
...
lrreduce = ReduceLROnPlateau(monitor='val_loss', factor=0.3, patience=20, verbose=1, mode='auto', epsilon=0.0001, cooldown=0, min_lr=0)
...
class_weight = {0 : 1.05, 1: 4., 2: 1.}
#class_weight = {0 : 2.7, 1: 1.1, 2: 1.5} # applied smoothing .1
...
plt.plot(history.history['categorical_crossentropy'][5:])
