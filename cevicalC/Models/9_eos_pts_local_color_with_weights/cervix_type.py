...
train_data_dir = '../../data/train_split_clahe_256px_crop_auto_50'
val_data_dir = '../../data/val_split_clahe_256px_crop_auto_50'
best_model_file = "./ex1_model_clahe_lcolor_50wh.h5"
...
x = conv2d_bn(img_input, 4, 3, 3, strides=(2, 2), padding='same')
x = conv2d_bn(x, 4, 3, 3, padding='same')
x = conv2d_bn(x, 4, 3, 3)
x = MaxPooling2D((3, 3), strides=(2, 2))(x)

x = conv2d_bn(x, 4, 1, 1, padding='same')
x = conv2d_bn(x, 4, 3, 3, padding='same')
x = MaxPooling2D((3, 3), strides=(2, 2))(x)
...
branch3x3dbl = conv2d_bn(branch3x3dbl, 4, 3, 3)
branch3x3dbl = conv2d_bn(branch3x3dbl, 4, 3, 3)
...
branch3x3 = conv2d_bn(x, 4, 3, 3, strides=(2, 2), padding='valid')

branch3x3dbl = conv2d_bn(x, 4, 1, 1)
branch3x3dbl = conv2d_bn(branch3x3dbl, 4, 3, 3)
branch3x3dbl = conv2d_bn(
    branch3x3dbl, 4, 3, 3, strides=(2, 2), padding='valid')
...
branch7x7 = conv2d_bn(x, 8, 1, 1)
branch7x7 = conv2d_bn(branch7x7, 8, 1, 7)
branch7x7 = conv2d_bn(branch7x7, 8, 7, 1)

branch7x7dbl = conv2d_bn(x, 8, 1, 1)
branch7x7dbl = conv2d_bn(branch7x7dbl, 8, 7, 1)
branch7x7dbl = conv2d_bn(branch7x7dbl, 8, 1, 7)
branch7x7dbl = conv2d_bn(branch7x7dbl, 8, 7, 1)
branch7x7dbl = conv2d_bn(branch7x7dbl, 8, 1, 7)
