...
best_model_file = "./ex1_model_local_color_500ep.h5"
...
model.add(Convolution2D(16, (3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
model.add(Dropout(0.15))

model.add(ZeroPadding2D((1,1)))
model.add(Convolution2D(16, (3, 3), strides=(2,2), activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
...
#stage 4
model.add(ZeroPadding2D((1,1)))
model.add(Convolution2D(32, (3, 3), activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
...
# replace pooling by conv
model.add(ZeroPadding2D((1,1)))
model.add(Convolution2D(32, (3, 3), strides=(2,2), activation='relu', kernel_regularizer=regularizers.l2(0.00001)))
