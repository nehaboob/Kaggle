...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 15:17:25 2017
...
root_path = '.'
weights_path = os.path.join(root_path, 'Res50_Pop_lr0001.h5')
...
f_submit = open(os.path.join(root_path, 'submit_Res50_Pop_lr0001.csv'), 'w')
