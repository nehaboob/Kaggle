...
# plot simple graph
'''
plt.plot(macro.timestamp , macro.cpi, 'ro')
plt.plot(macro.timestamp, macro.ppi , 'ro')

plt.plot(macro.timestamp, macro.gdp_quart , 'ro')
plt.plot(macro.timestamp, macro.gdp_quart_growth , 'ro')

plt.plot(train.oil_urals, train.price_doc, 'ro')
plt.plot(train.gdp_quart , train.price_doc, 'ro')
plt.plot(train.gdp_quart_growth , train.price_doc, 'ro')
plt.plot(train.cpi , train.price_doc, 'ro')
plt.plot(train.ppi , train.price_doc, 'ro')
'''
...
internal_chars.append('price_doc')
